...
% 
% Output:
%   annotations: a vectir containing the time instants in seconds
%
...
for p = 0:numPoints
  ...
  currItemAttribs = points.item(p).getAttributes;
